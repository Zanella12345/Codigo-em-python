        ...
        for i in range(1):
            ...
            for i in range(numeroClientes):
                ...
                for i in range(1):
                    ...
                    pyautogui.leftClick(duration=0.5)
    elif respColeta1 == 'Coleta2': 
        pyautogui.alert(text = 'em desemvolvimento')
        webbrowser.open('https://docs.google.com/spreadsheets/u/0/')
        webbrowser.open('https://docs.google.com/spreadsheets/u/0/')
        sleep(6)
        pyautogui.moveTo(2323,345, duration=1)
        pyautogui.leftClick(duration=0.5)
        pyautogui.moveTo(2104,15,duration=1)
        pyautogui.leftClick(duration=0.5)
        for i in range(numeroClientesExtrato):
                for i in range(1):
                    pyautogui.moveTo(2133,368, duration=1)
                    pyautogui.leftClick(duration=0.5)
                    pyautogui.hotkey('ctrl', 'c')
                for i in range(1):
                    def coletarNome() :
                ...
                for i in range(1):
                    ...
                    nomeFinal = ''.join(nomeDividido)
                for i in range(1):
                    pyautogui.moveTo(2678,11, duration=1)
                    pyautogui.leftClick(duration=0.5)
                    pyautogui.moveTo(2099,332, duration=1)
                    pyautogui.leftClick(duration=0.5)
                    pyautogui.typewrite(nomeFinal)
                ...
                #adicionar valores
                for i in range(1):
                    pyautogui.moveTo(2103,10, duration=1)
                    pyautogui.leftClick(duration=0.5)
                    pyautogui.moveTo(2299,364, duration=1)
                    pyautogui.leftClick(duration=0.5)
                    pyautogui.hotkey('ctrl', 'c')
                    pyautogui.moveTo(2687,6, duration=1)
                    pyautogui.leftClick(duration=0.5)
                    pyautogui.moveTo(2557,333, duration=0.5)
                    pyautogui.leftClick(duration=0.5)
                    pyautogui.hotkey('ctrl', 'v')
                ...
                for i in range(1):
                    ...
                    pyautogui.moveTo(2197,490, duration=1)
                    pyautogui.leftClick(duration=1)
                    pyautogui.moveTo(2090,13, duration=0.5)
                    pyautogui.leftClick(duration=0.5)
                for i in range(1):
                    pyautogui.moveTo(2039,363, duration=0.5)
                    sleep(0.5)
